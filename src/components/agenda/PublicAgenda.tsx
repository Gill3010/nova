        ...
        <div className="flex flex-col gap-3 relative z-10">
          ...
          {actividad.descripcion && (
            <div className="flex items-center gap-2 mt-1">
              {actividad.foto_ponente ? (
                <img 
                  src={actividad.foto_ponente} 
                  alt={actividad.descripcion} 
                  className="h-8 w-8 rounded-full object-cover border border-slate-200 dark:border-slate-700 shadow-sm shrink-0"
                />
              ) : (
                <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 flex items-center justify-center shrink-0">
