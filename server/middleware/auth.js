...
// Middleware genérico para autorizar roles específicos
const authorize = (...roles) => {
  return (req, res, next) => {
    ...
    if (!hasRole) {
      logger.warn('Intento de acceso denegado por falta de rol', { user: req.user, requiredRoles: roles });
...
module.exports = { verifyToken, isAdminOrOrganizer, authorize };
